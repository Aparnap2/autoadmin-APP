...
class AgentCapabilities(BaseModel):
    ...
    max_concurrent_tasks: int = Field(ge=1, le=50, description="Maximum concurrent tasks")
    ...
    average_execution_time: float = Field(ge=0, description="Average execution time in seconds")
...
class AgentConfig(BaseModel):
    ...
    schedule: Optional[Dict[str, Any]] = Field(default=None, description="Agent schedule")
...
class AgentTask(BaseModel):
    ...
    expected_duration: Optional[int] = Field(default=None, description="Expected duration in seconds")
...
class AgentTaskRequest(BaseModel):
    ...
    type: TaskType = Field(description="Task type")
    priority: TaskPriority = Field(default=TaskPriority.MEDIUM, description="Task priority")
    agent_type: Optional[AgentType] = Field(default=None, description="Preferred agent type")
